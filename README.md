...
```
cd existing_repo
git remote add origin https://u-gitlab.uzinfocom.uz/emehmon/management/front.git
git branch -M main
...
- [ ] [Set up project integrations](https://u-gitlab.uzinfocom.uz/emehmon/management/front/-/settings/integrations)
