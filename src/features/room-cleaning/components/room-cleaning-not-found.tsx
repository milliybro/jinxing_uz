  ...
  return (
    <div className="w-full flex text-center flex-col justify-center items-center">
      ...
      <Typography.Text className="text-[24px] mb-4 font-semibold leading-[30.6px] text-primary-dark">
        {t('room-cleaning-page.not-found.title')}
      </Typography.Text>
      <Typography.Text className="max-w-[592px] mb-4 text-secondary">
        {t('room-cleaning-page.not-found.description')}
      </Typography.Text>
      <Button
        type="link"
        size="large"
      ...
      >
        {t('room-cleaning-page.not-found.reset')}
      </Button>
    </div>
  )
}

export default RoomCleaningNotFound
