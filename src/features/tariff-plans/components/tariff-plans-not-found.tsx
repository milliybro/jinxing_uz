...
const TariffPlansNotFound: FC<IProps> = ({ setOpenDrawer }) => {
    ...
    <div className="flex flex-col justify-center items-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <Typography.Text className="text-[24px] font-semibold">
          {t('tariff-plans-page.not-found.title')}
        </Typography.Text>
        <Typography.Text className="max-w-[514px] text-center text-secondary">
          {t('tariff-plans-page.not-found.desc')}
        </Typography.Text>
        <Button
          type="link"
          size="small"
        ...
        >
          ...
          {t('tariff-plans-page.add-tariff')}
        </Button>
      </div>
    </div>
  )
...
export default TariffPlansNotFound
