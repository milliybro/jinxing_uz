...
const TariffPlansHeader: FC<IProps> = ({ setOpenDrawer }) => {
    ...
    <div className="flex flex-col">
      <Breadcrumb
        items={[
          ...
          // { title: t('common.tariff-and-numbers') },
          {
            title: t('common.tariff-plans'),
          },
        ]}
      />
...
export default TariffPlansHeader
