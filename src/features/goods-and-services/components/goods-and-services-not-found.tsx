...
const GoodsAndServicesNotFound: FC<IProps> = ({ setOpenDrawer }) => {
    ...
    <div className="flex flex-col justify-center items-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <Typography.Text className="text-[24px] font-semibold">
          {t('goods-and-services.not-found.title')}
        </Typography.Text>
        <Typography.Text className="max-w-[514px] text-center text-secondary">
          {t('goods-and-services.not-found.desc')}
        </Typography.Text>
        <Button
          type="link"
          size="small"
        ...
        >
          ...
          {t('goods-and-services.not-found.add-goods-service')}
        </Button>
      </div>
    </div>
  )
...
export default GoodsAndServicesNotFound
