...
const GuestBookingSteps = () => {
  ...
  return (
    <Steps
      ...
      className="mb-6 custom-steps [&_.ant-steps-item-title]:font-semibold [&_.ant-steps-item-title]:text-primary-dark dark:[&_.ant-steps-item-title]:text-white dark:[&_.ant-steps-icon]:text-white"
    />
  )
}

export default GuestBookingSteps
